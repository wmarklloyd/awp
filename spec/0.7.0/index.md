...
**Canonical release:** `https://github.com/wmarklloyd/awp/tree/v0.7.0/spec/0.7.0`  
...
The documents listed in Section 2, their normative schemas, and the module registry constitute the AWP 0.7.0 stable exploratory release. Released documents and schemas are immutable; corrections require an erratum or a new version.
