# AWP Coordination 0.3.0 — Draft

**Module ID:** `urn:awp:coordination`  
**Module version:** `0.3.0-draft.2`  
**Status:** Experimental design draft; not a published AWP family version  
**Depends on:** AWP Core `0.5.x`, AWP Synchronization `0.2.x`  
**Replaces for review:** Coordination `0.2.0`
...
The draft is not ready for promotion without fixtures covering at least:
...
Coordination 0.3.0 should not become normative until:
...
This draft turns Coordination from a descriptive vocabulary into a candidate executable protocol. C1 defines durable deterministic coordination that works across agents and hosts. C2 adds semantic awareness and early conflict detection. C3 adds live enforcement only where a protected system can prove it.
