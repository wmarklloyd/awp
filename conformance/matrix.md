...
| Simpler model participation adapter | Experimental participation contract 0.1 | 3 request/response/receipt examples | 5 local read/announce, idempotency, overlap, and request-validation tests | 0 | Read/announce slice only; publish, interact, checkpoint, host authority, and complete C1 composition remain outstanding |
