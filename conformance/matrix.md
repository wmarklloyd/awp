...
| Simpler model participation adapter | Experimental participation contract 0.1 | 3 request/response/receipt examples | 13 local read/announce/publish/interact/checkpoint, idempotency, overlap, scope, freshness, and request-validation tests | 0 | Continue-checkpoint slice only; exit checkpointing, host authority, and complete C1 composition remain outstanding |
