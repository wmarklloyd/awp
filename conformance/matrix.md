...
| Cooperation Contract CC-1 | Cooperation Contracts 0.1 draft | None | Existing local ledger, presence, and participation tests are reusable but do not cover the complete profile | 0 | Experimental profile only; atomic guarded writes, bounded interaction loops, checkpoint projection, recovery, and multi-participant evidence remain to be composed |
