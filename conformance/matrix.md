...
| Simpler model participation adapter | Experimental participation contract 0.1 | 3 request/response/receipt examples | 8 local read/announce/publish, idempotency, overlap, scope, and request-validation tests | 0 | Read/announce/publish slice only; interact, checkpoint, host authority, and complete C1 composition remain outstanding |
