...
| C1 deterministic projector foundation | Coordination draft 0.4, Sections 4, 15, and 17 | Coordination event schema coverage | 10 transport-order, ancestry, revision, lifecycle, cross-record, verification-binding, contest, and mismatch tests | 0 | Reusable projector foundation; complete transition fixtures and independent implementation remain outstanding |
