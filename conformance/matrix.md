...
| C1 deterministic projector foundation | Coordination draft 0.4, Sections 4, 15, and 17 | Coordination event schema coverage | 6 transport-order, ancestry, revision, lifecycle, contest, and mismatch tests | 0 | Reusable projector foundation; cross-record validator, complete transition fixtures, and independent implementation remain outstanding |
