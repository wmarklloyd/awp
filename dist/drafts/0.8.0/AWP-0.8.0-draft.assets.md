...
```json
{
  ...
  "requirements": [
    ...
    },
    {
      ...
      "source": "spec/drafts/0.8.0/index.md",
      "line": 27,
      "statement": "**Decision Durability** is a family invariant: an accepted decision remains discoverable and applicable across sessions and participants until it is explicitly superseded, revoked, expired, or outside the scope of contemplated work. Its effective choice, applicability, source, and supersession lineage MUST remain inspectable; omission from a summary or bounded model context MUST NOT silently cancel it."
    },
    {
      "id": "AWP-FAMILY-003",
      "source": "spec/drafts/0.8.0/index.md",
    ...
    },
    {
      ...
      "source": "spec/drafts/0.8.0/capsule.md",
      "line": 23,
      "statement": "A single-file Markdown capsule is the canonical project workstate document and normative project entry point. It MUST carry the metadata needed to interpret itself and MAY point to other files, artifacts, schemas, entry profiles, or binding descriptors needed for continuation. A host MAY receive its path explicitly or locate it through an unambiguous project convention."
    },
    {
      "id": "AWP-CAPSULE-004",
      "source": "spec/drafts/0.8.0/capsule.md",
      "line": 25,
      "statement": "The front matter of a project capsule MUST include `format: single-file-capsule` and `discovery: project`. Its `specification` metadata identifies the exact specification artifact governing the workstate. The Capsule path and declared project root establish the project boundary together; receiving an arbitrary file called a capsule outside a declared project does not establish collaboration authority."
    },
    {
      "id": "AWP-CAPSULE-005",
      "source": "spec/drafts/0.8.0/capsule.md",
      "line": 27,
      "statement": "When no explicit path names the Capsule, an implementation MAY look for the conventional `<project-name>.awp.md` or `project.awp.md` in the project root. It MUST NOT silently choose among multiple candidate capsules. A filename is only a locator and MUST NOT be used to infer protocol compatibility. A companion repository file such as `.awp.json` MAY point to the Capsule as a host convenience, but it is non-authoritative, MUST NOT duplicate effective workstate semantics, and MUST NOT override or replace Capsule metadata. Discovering a declared URI MUST NOT trigger automatic network access."
    },
    {
      "id": "AWP-CAPSULE-006",
      "source": "spec/drafts/0.8.0/capsule.md",
    ...
    },
    {
      ...
      "source": "spec/drafts/0.8.0/capsule.md",
      "line": 94,
      "statement": "A task-scoped entry view MUST additionally carry the bounded explicit decision closure defined by Core and report `decision_context` independently as `complete`, `partial`, `conflicting`, `stale`, or `unverifiable`. The view MUST include each effective decision's identifier, status, question, choice, `affects`, source reference, lineage head, and ancestor identifiers; it MAY defer ancestor prose. Structural selection `complete` MUST NOT imply decision-context `complete`. A participant MUST NOT begin guarded work unless both are complete, except under a bounded continuation recorded by the applicable decision owner."
    },
    {
      "id": "AWP-CAPSULE-015",
      "source": "spec/drafts/0.8.0/capsule.md",
      "line": 96,
      "statement": "The host MUST derive contemplated work from the Resume and Handoff, including their requested action, `read_first`, required artifacts, state bindings and scopes, together with any narrower intended scope declared at entry. It MUST include every unscoped effective decision and every explicitly applicable decision rather than relying only on a hand-authored `read_first` list. If the host cannot determine applicability, verify a required decision source, or close a lineage, it MUST report `AWP-DECISION-CONTEXT-INCOMPLETE` and the corresponding non-complete `decision_context` value."
    },
    {
      "id": "AWP-CAPSULE-016",
      "source": "spec/drafts/0.8.0/capsule.md",
    ...
    },
    {
      ...
      "source": "spec/drafts/0.8.0/action-boundary.md",
      "line": 15,
      "statement": "This module does not claim that AWP replaces runtime authorization, sandboxing, or an organization's own policy enforcement, and it does not claim that a well-formed resolution proves the resulting artifact is true, safe, or correct \u2014 only that a declared, vocabulary-matched action was checked against structured decisions, by a component the acting participant does not control, before it took effect. A deployment that records these structures without gating a real mutation path MUST NOT claim the `action-enforced` or `output-attested` levels defined in \u00a79; \u00a71 of the Adapter Framework already establishes that a portable guardrail is policy state, not proof of enforcement, and this module inherits that distinction rather than replacing it."
    },
    {
      "id": "AWP-ACTIONBOUNDARY-003",
      "source": "spec/drafts/0.8.0/action-boundary.md",
      "line": 23,
      "statement": "A **policy author** is the human role responsible for declaring protected action classes and authoring the decisions that govern them. The policy author is distinct from, and MUST NOT be, the participant whose actions are being gated \u2014 the same actor cannot both be constrained by a policy and be its sole author, or the policy constrains nothing. A project MAY name its decision owner as policy author, but MUST record that as an explicit choice, not a default."
    },
    {
      "id": "AWP-ACTIONBOUNDARY-004",
      "source": "spec/drafts/0.8.0/action-boundary.md",
      "line": 33,
      "statement": "Reading, validating, acknowledging, or summarizing a workstate MUST NOT by itself satisfy action-boundary decision resolution; resolution is computed per action, not once at session entry."
    },
    {
    ...
    },
    {
      ...
      "source": "spec/drafts/0.8.0/action-boundary.md",
      "line": 77,
      "statement": "When the capsule projection is `budget_exceeded`, when independent `decision_context` is absent, when the operation is not in the declared vocabulary, or when class or scope applicability is unknown, the result MUST be `unresolved`, never `permit`. Delegated, tool-mediated, decomposed, retried, and derived operations MUST inherit every mandatory decision and guardrail applicable to the originating action; a child tool call under a resolved parent task does not re-resolve scope independently of that parent."
    },
    {
    ...
    },
    {
      ...
      "source": "spec/drafts/0.8.0/action-boundary.md",
      "line": 153,
      "statement": "- Protected action classes, their vocabulary, and their policy author MUST be declared by receiver or project policy; this module does not define a default protected set or assume any project has appointed a policy author."
    },
    {
    ...
    },
    {
      ...
      "source": "spec/drafts/0.8.0/action-boundary.md",
      "line": 156,
      "statement": "- This module MUST NOT be represented as proof that a record's subject matter is true, safe, or correct \u2014 only that a declared, vocabulary-matched action was checked against structured decisions by a component the participant does not control, before it took effect."
    },
    {
      "id": "AWP-ACTIONBOUNDARY-023",
      "source": "spec/drafts/0.8.0/action-boundary.md",
      "line": 158,
      "statement": "A deployment MAY remain advisory and honestly claim only `context-aware` or `decision-resolved` behavior. Enforcement and the tool constraint in \u00a75 become mandatory only when the deployment claims prevention for a declared protected action class."
    },
    {
      "id": "AWP-COOP-001",
    ...
    },
    {
      ...
      "source": "spec/drafts/0.8.0/cooperation-contracts.md",
      "line": 194,
      "statement": "When `local-git-ref-doorbell-v1` is selected, the binding MUST create a content-free ref under `refs/awp/signal/` only after the authoritative ledger event commits. The ref name MUST carry the event identifier and its target MUST identify the repository revision at publication. A recipient watcher MUST treat the ref as a coalescing hint, refresh the ledger, correlate binding identity, event identifier, and frontier, and retain a cursor so repeated ref observations are idempotent. The profile is local to the repository's reachable Git common directory unless an explicit host binding supplies fetch or push; a ref's existence MUST NOT imply that another host can see it. A missing, stale, or inaccessible ref while the ledger remains readable MUST produce `AWP-SIGNAL-UNVERIFIED`, not `AWP-COORD-LEDGER-UNAVAILABLE`."
    },
    {
      "id": "AWP-COOP-043",
      "source": "spec/drafts/0.8.0/cooperation-contracts.md",
    ...
    },
    {
      ...
      "source": "spec/drafts/0.8.0/cooperation-contracts.md",
      "line": 325,
      "statement": "**Migration.** Migrating a ledger from another profile MUST preserve every event identifier and event document and the binding identity, and MUST be idempotent."
    },
    {
      "id": "AWP-COOP-086",
      "source": "spec/drafts/0.8.0/cooperation-contracts.md",
      "line": 333,
      "statement": "**One serialized ref.** The profile MUST keep the coordination history of a project on one ref shared by all participants (the reference binding uses `refs/awp/coordination/<project>`). Each commit MUST carry exactly one transaction document and MUST have as its only parent the commit the transaction was computed against. A transaction document MUST contain every event the operation appended, in order, and MAY contain request-idempotency entries and scan-cursor entries written by the same operation."
    },
    {
      "id": "AWP-COOP-087",
      "source": "spec/drafts/0.8.0/cooperation-contracts.md",
      "line": 335,
      "statement": "**Atomic announce-and-check.** An operation MUST read the ref, rebuild the ledger state at that commit, evaluate the operation (including overlap detection against every active intent and lease), and then advance the ref by compare-and-swap from that commit to the new one. If the ref moved, the operation MUST write nothing and MUST be re-evaluated against the new state. This satisfies the atomicity required by Section 4.1: no announcement can be accepted between another announcement's check and its write. An operation that writes nothing MUST NOT create a commit."
    },
    {
      "id": "AWP-COOP-088",
      "source": "spec/drafts/0.8.0/cooperation-contracts.md",
      "line": 337,
      "statement": "**Derived records.** Intents, scopes, leases, overlaps, and other coordination records MUST NOT be stored separately from events. A binding MUST rebuild them by replaying the events' replacement records in order, and MUST refuse to publish a transaction whose record changes cannot be reproduced by replaying its events. Any index used to query the rebuilt state is a process-local cache and MUST NOT be treated as durable."
    },
    {
      "id": "AWP-COOP-089",
      "source": "spec/drafts/0.8.0/cooperation-contracts.md",
      "line": 339,
      "statement": "**Remote serialization.** With a remote configured, the push of the new commit to the remote's coordination ref MUST be the compare-and-swap: a push that is not a fast-forward MUST be treated as a moved ref, and the operation re-evaluated on the fetched state. The local ref MUST be advanced only after the remote accepted the commit. The privacy rule of Section 10 applies to coordination refs as well."
    },
    {
      "id": "AWP-COOP-090",
      "source": "spec/drafts/0.8.0/cooperation-contracts.md",
      "line": 341,
      "statement": "**Migration.** Migrating from another coordination store MUST preserve every event identifier and document and the binding identity, MUST verify that replay reproduces the source's records and their order before writing anything, MUST carry request-idempotency answers over, MUST translate consumer cursors to the new sequence, and MUST refuse to run over existing Git coordination history."
    },
    {
      "id": "AWP-COOP-091",
      "source": "spec/drafts/0.8.0/cooperation-contracts.md",
      "line": 343,
      "statement": "**Limits.** The profile inherits Section 10's limits: actors are self-asserted, and history is not encrypted. Write contention on the single ref is expected to be low at `COOP-1` and `COOP-2` group sizes; a binding that observes sustained compare-and-swap retries SHOULD disclose it rather than silently degrading."
    },
    {
      "id": "AWP-COOP-092",
      "source": "spec/drafts/0.8.0/cooperation-contracts.md",
      "line": 349,
      "statement": "**Wake classes.** A wake binding MUST declare one class: `W1` live-session injection into an open conversation; `W2` a new non-interactive run of the agent in the project with the notice as its input; `W3` a hosted session started or continued through the agent vendor's API; `W4` a forge issue, pull-request, or mention event that the agent watches; or `W5` notification of the principal. Every participant is additionally reachable by entry recovery (`W0`), which no binding replaces."
    },
    {
      "id": "AWP-COOP-093",
      "source": "spec/drafts/0.8.0/cooperation-contracts.md",
      "line": 351,
      "statement": "**Binding declarations.** A participant that can be woken MUST publish one declaration per binding naming the actor, class, adapter profile, the relay that serves it, its acknowledgement window, and its budget. A declaration MUST reference any credential it needs by name only; credentials MUST NOT appear in the ledger, the repository, a notice, or an activation envelope. A relay MUST NOT execute a binding that names a different relay."
    },
    {
      "id": "AWP-COOP-094",
      "source": "spec/drafts/0.8.0/cooperation-contracts.md",
      "line": 353,
      "statement": "**Verified reach.** A relay MUST probe a binding when it is declared and after any failure, and the participant inventory MUST report reach per binding as `verified` (with time and observed latency), `failed`, or `unverified`. A declared binding that has not passed a probe MUST NOT be reported as reach."
    },
    {
      "id": "AWP-COOP-095",
      "source": "spec/drafts/0.8.0/cooperation-contracts.md",
      "line": 355,
      "statement": "**Delivery ladder.** For each addressed event a relay MUST try the recipient's bindings in declared order, MUST record a transport receipt as the relay for each attempt, and MUST wait for a recipient receipt within that binding's acknowledgement window before escalating to the next binding. Each escalation MUST be recorded. When no binding yields a recipient receipt, the relay MUST notify the principal where a `W5` binding exists and MUST record the outcome. Events for one recipient arriving within a short window MAY share one wake. A relay MUST respect each binding's budget and MUST stop using a binding that keeps failing, disclosing why, until a probe succeeds again. The ladder MUST NOT delay, replace, or hide entry recovery."
    },
    {
      "id": "AWP-COOP-096",
      "source": "spec/drafts/0.8.0/cooperation-contracts.md",
      "line": 357,
      "statement": "**Never silent.** Every addressed event MUST end in a recipient receipt, a recorded principal notification, or a disclosed entry-only status, and the sender MUST be able to read which. Before publishing, a sender's tools SHOULD report the best verified binding for the recipient."
    },
    {
      "id": "AWP-COOP-097",
      "source": "spec/drafts/0.8.0/cooperation-contracts.md",
      "line": 359,
      "statement": "**Receipts.** Section 9's provenance values are extended with `host-launch`: a host runner started a session whose first input was the notice and reported that session's identifier. Transport receipts and principal notifications MUST NOT be recorded or counted as recipient receipts."
    },
    {
      "id": "AWP-COOP-098",
      "source": "spec/drafts/0.8.0/cooperation-contracts.md",
      "line": 361,
      "statement": "**Bounded runs.** A `W2` or `W3` run MUST start with the minimum permissions needed to read the project and record receipt, and MUST acquire any further authority only from the interaction's recorded authorization. A binding MUST NOT rely on options that grant an agent unrestricted tool use outside a sandbox."
    },
    {
      "id": "AWP-COOP-099",
      "source": "spec/drafts/0.8.0/cooperation-contracts.md",
      "line": 363,
      "statement": "**Hosted and forge rungs.** A `W3` or `W4` binding MUST send identifiers only. A hosted session that has to read the ledger MUST reach it through a path whose audience matches the interaction's, such as a private remote or the vendor's link to the principal's own computer."
    },
    {
      "id": "AWP-COOP-100",
      "source": "spec/drafts/0.8.0/cooperation-contracts.md",
        ...
        },
        {
          ...
          "then": {
            ...
            "properties": {
              ...
              "status": { "enum": ["proposed", "accepted", "rejected", "deferred", "reopened", "superseded", "revoked", "expired"] },
              "choice": { "type": "string", "minLength": 1 },
              "rationale": { "type": "string", "minLength": 1 },
              "affects": { "$ref": "#/$defs/referenceArray" },
              "supersedes": { "$ref": "#/$defs/referenceArray" },
              "supersession_rationale": { "type": "string", "minLength": 1 },
            ...
            "allOf": [
              ...
              {
                "if": { "required": ["supersedes"], "properties": { "supersedes": { "minItems": 1 } } },
                "then": { "required": ["supersession_rationale"] }
              }
            ]
          }
        },
...
```json
{
  ...
  "oneOf": [
    ...
    {"$ref": "#/$defs/activationBinding"},
    {"$ref": "#/$defs/activationEnvelope"},
  ...
  "$defs": {
    ...
    "activationBinding": {
      "type": "object",
      "required": ["type", "module", "profile", "actor", "host", "route_id", "route_generation", "activation", "adapter", "ledger_replay"],
      "properties": {
        "type": {"const": "cooperation_activation_binding"},
        "module": {"const": "urn:awp:cooperation"},
        "profile": {"const": "awp-host-activation-v1"},
        "actor": {"$ref": "#/$defs/id"},
        "host": {"$ref": "#/$defs/id"},
        "route_id": {"$ref": "#/$defs/id"},
        "route_generation": {"$ref": "#/$defs/id"},
        "activation": {"enum": ["startup-hook", "managed-launcher", "subscription"]},
        "adapter": {"$ref": "#/$defs/id"},
        "ledger_replay": {"const": "durable-cursor"},
        "hint_channel": {"enum": ["git-ref", "filesystem", "subscription", "none"]}
      },
      "additionalProperties": true
    },
    "activationEnvelope": {
      "type": "object",
      "required": ["type", "module", "profile", "operation_id", "binding_id", "project_id", "workstate_id", "recipient_actor", "route_id", "route_generation", "event_id", "event_kind", "ledger_frontier"],
      "properties": {
        "type": {"const": "cooperation_activation_envelope"},
        "module": {"const": "urn:awp:cooperation"},
        "profile": {"const": "awp-host-activation-v1"},
        ...
        "project_id": {"$ref": "#/$defs/id"},
        "workstate_id": {"$ref": "#/$defs/id"},
        "recipient_actor": {"$ref": "#/$defs/id"},
        "route_id": {"$ref": "#/$defs/id"},
        "route_generation": {"$ref": "#/$defs/id"},
        "event_id": {"$ref": "#/$defs/id"},
        "event_kind": {"$ref": "#/$defs/id"},
        "interaction_id": {"$ref": "#/$defs/id"},
        "ledger_frontier": {"type": "array", "items": {"$ref": "#/$defs/id"}, "uniqueItems": true}
      },
      "additionalProperties": false
    },
    "transportReceipt": {
      "type": "object",
      "required": ["type", "module", "profile", "operation_id", "event_id", "recipient_actor", "route_id", "route_generation", "state", "recorded_at"],
      "properties": {
        "type": {"const": "cooperation_transport_receipt"},
        "module": {"const": "urn:awp:cooperation"},
        "profile": {"const": "awp-host-activation-v1"},
        "operation_id": {"$ref": "#/$defs/id"},
        "event_id": {"$ref": "#/$defs/id"},
        ...
        "route_id": {"$ref": "#/$defs/id"},
        "route_generation": {"$ref": "#/$defs/id"},
        "state": {"enum": ["transport_queued", "transport_deferred", "transport_unavailable"]},
        "recorded_at": {"type": "string", "format": "date-time"},
        "endpoint_receipt": {"$ref": "#/$defs/id"},
        "reason": {"type": "string"}
      },
      "additionalProperties": true
    },
