"""Validate the AWP 0.8 modular specification family."""
...
FAMILY = ROOT / "spec" / "drafts" / "0.8.0" / "index.md"
SPEC_DIR = ROOT / "spec" / "drafts" / "0.8.0"
REGISTRY = SPEC_DIR / "modules.json"
REGISTRY_SCHEMA = ROOT / "schemas" / "awp-module-registry-0.8.schema.json"
CORE_SCHEMA = ROOT / "schemas" / "awp-core-0.8.schema.json"
COORDINATION_SCHEMA = ROOT / "schemas" / "awp-coordination-0.5.schema.json"
...
def validate_registry(failures: list[str]) -> dict:
    ...
    if core is None or core["status"] != "required" or core["version"] != "0.8.0":
        failures.append("module registry must contain required urn:awp:core version 0.8.0")
