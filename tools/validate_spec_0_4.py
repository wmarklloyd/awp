"""Validate the AWP 0.4 modular specification family."""
...
CORE_SCHEMA = ROOT / "schemas" / "awp-core-0.4.schema.json"
...
def validate_registry(failures: list[str]) -> dict:
    ...
    if core is None or core["status"] != "required" or core["version"] != "0.4.0":
        failures.append("module registry must contain required urn:awp:core version 0.4.0")
