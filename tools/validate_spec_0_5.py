"""Validate the AWP 0.5 modular specification family."""
...
FAMILY = ROOT / "AWP_SPECIFICATION_0.5.0.md"
SPEC_DIR = ROOT / "spec" / "0.5.0"
REGISTRY = SPEC_DIR / "modules.json"
REGISTRY_SCHEMA = ROOT / "schemas" / "awp-module-registry-0.5.schema.json"
CORE_SCHEMA = ROOT / "schemas" / "awp-core-0.5.schema.json"
DISCOVERY_SCHEMA = ROOT / "schemas" / "awp-discovery-0.1.schema.json"
...
MODULE_RECORD_OWNERS = {
    ...
    "work_intent": "urn:awp:coordination",
    "coordination_scope": "urn:awp:coordination",
    "coordination_lease": "urn:awp:coordination",
    "interface_contract": "urn:awp:coordination",
    "change_set": "urn:awp:coordination",
    "coordination_conflict": "urn:awp:coordination",
    "integration_plan": "urn:awp:coordination",
}
...
def validate_registry(failures: list[str]) -> dict:
    ...
    if core is None or core["status"] != "required" or core["version"] != "0.5.0":
        failures.append("module registry must contain required urn:awp:core version 0.5.0")
