"""Validate the AWP 0.6 modular specification family."""
...
FAMILY = ROOT / "AWP_SPECIFICATION_0.6.0.md"
SPEC_DIR = ROOT / "spec" / "0.6.0"
REGISTRY = SPEC_DIR / "modules.json"
REGISTRY_SCHEMA = ROOT / "schemas" / "awp-module-registry-0.6.schema.json"
CORE_SCHEMA = ROOT / "schemas" / "awp-core-0.6.schema.json"
COORDINATION_SCHEMA = ROOT / "schemas" / "awp-coordination-0.3.schema.json"
...
def validate_registry(failures: list[str]) -> dict:
    ...
    if core is None or core["status"] != "required" or core["version"] != "0.6.0":
        failures.append("module registry must contain required urn:awp:core version 0.6.0")
