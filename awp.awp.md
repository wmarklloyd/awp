...
generated_digest: sha256:0b03697b02801bd7b1bbcfc2c9c34322a4266495f5ae2c7102105d558e613e93
---
...
<!-- awp:89e5d09a47714dcfaa5734d1f155a4e8:snapshot:start encoding="json" -->
{
  ...
  "records": {
    ...
    "evidence": [
      ...
      ,{"id": "evidence:c1-projector-validation", "type": "evidence", "evidence_type": "validation_run", "summary": "The transport-neutral projector tests passed for topological replay, transport-order independence, concurrent contested successors, invalid transitions, revision conflicts, missing ancestry, and workstate mismatch. The complete suite now has 30 tests; the 0.7 validator, 22 conformance fixtures, 137 links, and generated bundle validation also pass. This is a C1 foundation only: cross-record validation and independent interoperability remain unimplemented.", "observed_at": "2026-09-05T01:56:26Z"}
    ],
    "decisions": [
    ...
    "artifacts": [
      ...
      {"id": "artifact:conformance", "type": "artifact", "name": "Conformance evidence", "modules": {"urn:awp:artifact": {"status": "retrievable", "locations": [{"kind": "local", "path": "conformance/matrix.md"}], "integrity": {"algorithm": "sha256", "digest": "aa273533d0ea63922cb312c3a700331ed41f9f4e45cd07904017176ce4b21f30"}}}},
      ...
      ,{"id": "artifact:c1-projector", "type": "artifact", "name": "Transport-neutral C1 projector foundation", "modules": {"urn:awp:artifact": {"status": "retrievable", "locations": [{"kind": "local", "path": "tools/awp_projector.py"}], "integrity": {"algorithm": "sha256", "digest": "6fd96d89c850597bdb71db3ea02259bffdbb8d4536a698667fe1bd15c10f80af"}}}},
      {"id": "artifact:c1-projector-tests", "type": "artifact", "name": "C1 projector deterministic behavior tests", "modules": {"urn:awp:artifact": {"status": "retrievable", "locations": [{"kind": "local", "path": "tests/test_projector.py"}], "integrity": {"algorithm": "sha256", "digest": "15b6c1dacaab6887c3c7752fc371d4074eabe936619e2e011405ac90e1a6d14f"}}}}
    ],
    "executions": [],
    "changes": [
    ...
    "checkpoints": [{"id": "checkpoint:c1-projector-foundation", "type": "checkpoint", "frontier": ["evt:c1-projector-foundation-checkpoint"], "created_at": "2026-09-05T01:56:26Z", "summary": "A transport-neutral C1 projector foundation now validates event structure, workstate identity, ancestry, revisions, lifecycle transitions, and deterministic contested concurrency; complete cross-record C1 and independent interoperability remain the next work.", "recommended_next_action": {"action": "Complete cross-record C1 validation and the transport-neutral transition fixtures, then build an independent projector for differential interoperability testing.", "requires_authority": false}, "resumption_level": "semantic"}],
    "sessions": []
  },
  "modules": {
    "urn:awp:handoff": {
