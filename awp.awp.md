...
frontier:
  - evt:c1-projector-foundation-checkpoint
checkpoint: checkpoint:c1-projector-foundation
generated_at: 2026-09-05T02:05:11Z
generated_digest: sha256:2a19ca1f1fad2842ebb42578c711bfaa56921dee73578be3597dfbeede183c65
---
...
<!-- awp:89e5d09a47714dcfaa5734d1f155a4e8:snapshot:start encoding="json" -->
{
  "awp_version": "0.6.0",
  "workstate_id": "urn:uuid:conversation-awp-design-2026-09-03",
  "frontier": ["evt:c1-projector-foundation-checkpoint"],
  "generated_at": "2026-09-05T02:05:11Z",
  ...
  "records": {
    ...
    "evidence": [
      ...
      ,{"id": "evidence:c1-projector-validation", "type": "evidence", "evidence_type": "validation_run", "summary": "The transport-neutral projector tests passed for topological replay, transport-order independence, concurrent contested successors, invalid transitions, revision conflicts, missing ancestry, cross-record missing-reference detection, verification subject/base binding, workstate mismatch, and replay of events from the local ledger transport. The complete suite now has 33 tests; all five specification-family validators, the 0.7 validator, 22 conformance fixtures, repository-relative links, workstate artifact checks, and generated bundle validation also pass. This is a C1 foundation only: complete cross-record validation and independent interoperability remain unimplemented.", "observed_at": "2026-09-05T02:05:11Z"}
    ],
    "decisions": [
    ...
    "artifacts": [
      ...
      {"id": "artifact:conformance", "type": "artifact", "name": "Conformance evidence", "modules": {"urn:awp:artifact": {"status": "retrievable", "locations": [{"kind": "local", "path": "conformance/matrix.md"}], "integrity": {"algorithm": "sha256", "digest": "9e8cb40a9a2aff337a113813c14f1ce214bdc5f46364af2a39c1205e26900443"}}}},
      ...
      ,{"id": "artifact:c1-projector", "type": "artifact", "name": "Transport-neutral C1 projector foundation", "modules": {"urn:awp:artifact": {"status": "retrievable", "locations": [{"kind": "local", "path": "tools/awp_projector.py"}], "integrity": {"algorithm": "sha256", "digest": "1896cb100480dca6de8abe5dbff59d05330dbe9548d3fad177f7e3455b36c42f"}}}},
      {"id": "artifact:c1-projector-tests", "type": "artifact", "name": "C1 projector deterministic behavior tests", "modules": {"urn:awp:artifact": {"status": "retrievable", "locations": [{"kind": "local", "path": "tests/test_projector.py"}], "integrity": {"algorithm": "sha256", "digest": "e902e3eb7f1dcfd3bfe3a0d18ad19e032dc81608097522af586261fa84c59b81"}}}}
    ],
    "executions": [],
    "changes": [
      ...
      ,{"id": "change:c1-projector-foundation", "type": "change", "summary": "Added a transport-neutral deterministic C1 projector foundation and tests for topological replay, order independence, ancestry, revisions, lifecycle transitions, contested concurrency, and safe exclusion of invalid events.", "artifacts": ["artifact:c1-projector", "artifact:c1-projector-tests", "artifact:presence-spec", "artifact:spec-07-draft"]}
    ],
    "risks": [
    ...
    "checkpoints": [{"id": "checkpoint:c1-projector-foundation", "type": "checkpoint", "frontier": ["evt:c1-projector-foundation-checkpoint"], "created_at": "2026-09-05T02:05:11Z", "summary": "A transport-neutral C1 projector foundation now validates event structure, workstate identity, ancestry, revisions, lifecycle transitions, cross-record pinned references, verification subject/base binding, and deterministic contested concurrency; complete cross-record C1 and independent interoperability remain the next work.", "recommended_next_action": {"action": "Complete cross-record C1 validation and the transport-neutral transition fixtures, then build an independent projector for differential interoperability testing.", "requires_authority": false}, "resumption_level": "semantic"}],
    "sessions": []
  },
  "modules": {
    "urn:awp:handoff": {
      "handoff": {"id": "handoff:c1-projector-foundation", "type": "handoff", "module": "urn:awp:handoff", "checkpoint": "checkpoint:c1-projector-foundation", "completeness": "portable", "intended_audience": ["human", "agent"], "requested_action": "Complete cross-record C1 validation and the transport-neutral transition fixtures, then build an independent projector for differential interoperability testing.", "authority_ceiling": ["read_only", "local_write"], "resumption_level": "semantic", "do_not_assume": ["The projector foundation is a complete C1 implementation", "The local ledger adapter is a complete C1 projector or production implementation", "Advisory coordination is equivalent to C3 lease enforcement", "Imported authority grants external side effects"], "dependencies": [{"ref": "artifact:spec-06", "availability": "retrievable"}, {"ref": "artifact:spec-07-draft", "availability": "retrievable"}, {"ref": "artifact:presence-spec", "availability": "retrievable"}, {"ref": "artifact:c1-projector", "availability": "retrievable"}, {"ref": "artifact:c1-projector-tests", "availability": "retrievable"}, {"ref": "artifact:conformance", "availability": "retrievable"}]},
      "resume": {"id": "resume:awp-project", "type": "resume", "module": "urn:awp:handoff", "handoff": "handoff:c1-projector-foundation", "checkpoint": "checkpoint:c1-projector-foundation", "mode": "project_reentry", "read_first": ["goal:awp-design", "constraint:no-private-cot", "decision:release-discipline", "decision:c1-projector-boundary", "decision:ledger-awareness-default", "claim:c1-projector-foundation", "risk:c1-completeness", "task:c1-cross-record-validation", "task:coordination-prototype"], "required_artifacts": ["artifact:spec-07-draft", "artifact:presence-spec", "artifact:c1-projector", "artifact:c1-projector-tests", "artifact:conformance"], "recommended_next_action": "Complete cross-record C1 validation and the transport-neutral transition fixtures, then build an independent projector for differential interoperability testing.", "freshness_policy": "verify_before_continue", "on_stale": "refresh_workstate", "authority_ceiling": ["read_only", "local_write"]}
    },
