...
|---|---:|---|
| Entire source capsule | Approximately 56–57 KB | Authoritative source |
...
The complete selective view reduces participant-facing input by about 81 percent while retaining capsule integrity, governing metadata, authority ceiling, checkpoint, recommended action, the ordered re-entry records, and verified required-artifact digests and locations.
...
The read reduction does not remove the cost of maintaining the source Capsule. The current root Capsule is approximately 56–58 KB across fewer than 100 lines, with approximately 131 indexed records. Its snapshot is approximately 50 KB and its generated briefing is approximately 1 KB. It contains approximately 58 artifact descriptors with integrity digests. A full local artifact audit checks the historical and current descriptors; routine selective entry checks the seven artifacts required by the active Resume.
